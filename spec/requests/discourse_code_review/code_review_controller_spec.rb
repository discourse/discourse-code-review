...
describe DiscourseCodeReview::CodeReviewController do
  ...
  describe "#webhook" do
    ...
    it "can rename github repositories" do
      ...
      post "/code-review/webhook",
           headers: {
             "HTTP_X_HUB_SIGNATURE" => "sha1=c060d3354194566f042ca8ba7eadf4ac9f87eeda",
           },
           params: {
             repository: {
               id: 1,
  ...
  context "when signed in as an admin" do
    ...
    describe ".approve" do
      ...
      it "allows you to approve your own commit if enabled" do
        ...
        expect(commit.topic.tags.pluck(:name)).to include(
          "hi",
      ...
      it "does nothing when approving already approved posts" do
        ...
        expect {
          post "/code-review/approve.json", params: { topic_id: commit.topic_id }
        }.to change { commit.topic.posts.count }.by(1)
        expect {
          post "/code-review/approve.json", params: { topic_id: commit.topic_id }
        }.not_to change { commit.topic.posts.count }
      end
      ...
      it 'doesn\'t disturb tracking users' do
        ...
        topic_user = TopicUser.where(user_id: bystander.id, topic_id: commit.topic_id).first
    ...
    describe ".render_next_topic" do
      ...
      it "prefers unread topics over read ones" do
        ...
        TopicUser.create!(
          ...
          user: signed_in_user,
          last_read_post_number: read_commit.topic.highest_post_number,
        )
